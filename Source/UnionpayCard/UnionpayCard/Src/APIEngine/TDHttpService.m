...
+ (void)ShowUtocard:(UtocardInput *) utocardinput completionBlock:(TDCompletionBlock)aCompletionBlock {
    ...
    if (utocardinput.b_jname    != nil) [input setValue:utocardinput.b_jname forKeyPath:@"b_jname"];
    if (utocardinput.u_card     != nil) [input setValue:utocardinput.u_card forKeyPath:@"u_card"];
    if (utocardinput.card_state != nil) [input setValue:utocardinput.card_state forKeyPath:@"card_state"];
    TDHttpCommand * command = [TDHttpCommand new];
    command.inPut = input;
    [self postCommand:command completionBlock:aCompletionBlock];
}
...
+ (void)ShowConsumption:(ConsumptionInput *) consumptioninput completionBlock:(TDCompletionBlock)aCompletionBlock {
    ...
    if (consumptioninput.b_jname   != nil) [input setValue:consumptioninput.b_jname forKeyPath:@"b_jname"];
    if (consumptioninput.card      != nil) [input setValue:consumptioninput.card forKeyPath:@"card"];
    if (consumptioninput.scon_tmd  != nil) [input setValue:consumptioninput.scon_tmd forKeyPath:@"scon_tmd"];
    if (consumptioninput.mcon_tmd  != nil) [input setValue:consumptioninput.mcon_tmd forKeyPath:@"mcon_tmd"];
    if (consumptioninput.con_state != nil) [input setValue:consumptioninput.con_state forKeyPath:@"con_state"];
...
+ (void)ShowPreRecords:(RecordInput *) recordinput completionBlock:(TDCompletionBlock)aCompletionBlock {
    ...
    if (recordinput.b_jname     != nil) [input setValue:recordinput.b_jname forKeyPath:@"b_jname"];
    if (recordinput.card        != nil) [input setValue:recordinput.card forKeyPath:@"card"];
    if (recordinput.spre_r_tmd  != nil) [input setValue:recordinput.spre_r_tmd forKeyPath:@"spre_r_tmd"];
    if (recordinput.mpre_r_tmd  != nil) [input setValue:recordinput.mpre_r_tmd forKeyPath:@"mpre_r_tmd"];
    if (recordinput.acc_state   != nil) [input setValue:recordinput.acc_state forKeyPath:@"con_state"];
    if (recordinput.pre_type_id != nil) [input setValue:recordinput.pre_type_id forKeyPath:@"pre_type_id"];
