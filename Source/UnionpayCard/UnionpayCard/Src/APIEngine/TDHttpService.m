...
+ (void)ShowPreRecords:(RecordInput *) recordinput completionBlock:(TDCompletionBlock)aCompletionBlock {
    ...
    if (recordinput.acc_state   != nil && ![recordinput.acc_state isEqualToString:@""]) [input setValue:recordinput.acc_state forKeyPath:@"acc_state"];
...
+ (void)ShowBinfor:(BinforInput *)binforinput completionBlock:(TDCompletionBlock)aCompletionBlock {
    ...
    NSMutableDictionary * input = [NSMutableDictionary new];
    [input setValue:[self interfaceNameFromSelector:_cmd] forKey:@"method"];
    if (binforinput.b_name     != nil && ![binforinput.b_name isEqualToString:@""]) [input setValue:binforinput.b_name forKeyPath:@"b_name"];
    if (binforinput.b_no       != nil && ![binforinput.b_no isEqualToString:@""]) [input setValue:binforinput.b_no forKeyPath:@"b_no"];
    if (binforinput.b_jname    != nil && ![binforinput.b_jname isEqualToString:@""]) [input setValue:binforinput.b_jname forKeyPath:@"b_jname"];
    if (binforinput.b_type     != nil && ![binforinput.b_type isEqualToString:@""]) [input setValue:binforinput.b_type forKeyPath:@"b_type"];
    if (binforinput.b_2type    != nil && ![binforinput.b_2type isEqualToString:@""]) [input setValue:binforinput.b_2type forKeyPath:@"b_2type"];
    if (binforinput.b_htype    != nil && ![binforinput.b_htype isEqualToString:@""]) [input setValue:binforinput.b_htype forKeyPath:@"b_htype"];
    if (binforinput.b_province != nil && ![binforinput.b_province isEqualToString:@""]) [input setValue:binforinput.b_province forKeyPath:@"b_province"];
    if (binforinput.b_city     != nil && ![binforinput.b_city isEqualToString:@""]) [input setValue:binforinput.b_city forKeyPath:@"b_city"];
    if (binforinput.b_district != nil && ![binforinput.b_district isEqualToString:@""]) [input setValue:binforinput.b_city forKeyPath:@"b_district"];
    if (binforinput.b_cbd      != nil && ![binforinput.b_cbd isEqualToString:@""]) [input setValue:binforinput.b_cbd forKeyPath:@"b_cbd"];
    if (binforinput.b_crcle    != nil && ![binforinput.b_crcle isEqualToString:@""]) [input setValue:binforinput.b_crcle forKeyPath:@"b_crcle"];
    if (binforinput.b_sort     != nil && ![binforinput.b_sort isEqualToString:@""]) [input setValue:binforinput.b_sort forKeyPath:@"b_sort"];
    if (binforinput.b_t_state  != nil && ![binforinput.b_t_state isEqualToString:@""]) [input setValue:binforinput.b_t_state forKeyPath:@"b_t_state"];
